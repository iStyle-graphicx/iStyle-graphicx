...
export function HomeStart({ onAuthenticated }: HomeStartProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300 mb-8 animate-fade-in-delay">Premium Hardware Material Delivery</p>
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        ...
        <a
          href="https://wa.me/27746297208?text=Hi%20VanGo!%20I%20would%20like%20to%20register%20for%20an%20account%20as%20a%20Customer.%20My%20Email%20address%20is:"
          className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
        >
